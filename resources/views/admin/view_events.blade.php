    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <a href="{{ url('admin/add_event') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                ...
                <table id="devicesTable" class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @if (Auth::user()->role === 'Admin')
                            <td><a class="btn btn-success btn-sm btn-block" href="{{ route('updateEvent.admin',$item->event_id) }}">Edit</a></td>
                            @endif
                        </tr>
                        @endforeach
                    </tbody>
