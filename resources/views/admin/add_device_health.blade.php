        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Add Device Health</h1>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 col-md-offset-3">
                            ...
                            @endif
                            <form action="device_healths" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <input type="hidden" name="user_id" value="{{ auth()->user()->id }}">
                                <div class="row">
                                    <label for="device_type">Health</label>
